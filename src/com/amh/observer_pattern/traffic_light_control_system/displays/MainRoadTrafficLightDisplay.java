...
public class MainRoadTrafficLightDisplay implements Observer {

    public MainRoadTrafficLightDisplay(TrafficLight trafficLight) {
        trafficLight.addObserver(this);
    }

    @Override
    public void update(boolean red, boolean green, boolean yellow) {
        System.out.println("Main Road Traffic Light Display : "+ TrafficLightStatus(red,green,yellow));
    }
}
