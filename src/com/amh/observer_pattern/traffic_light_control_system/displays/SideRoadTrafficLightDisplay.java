...
public class SideRoadTrafficLightDisplay implements Observer {

    public SideRoadTrafficLightDisplay(TrafficLight trafficLight) {
        trafficLight.addObserver(this);
    }

    @Override
    public void update(boolean red, boolean green, boolean yellow) {
        System.out.println("Side Road Traffic Light Display : "+ TrafficLightStatus(red,green,yellow));
    }
}
